/**
 * Class: OpenLayers.Layer.Acid
 * Instances of OpenLayers.Layer.Acid are used to display data from Acid
 *     Maps Web Server.
 * 
 * Inherits from:
 *  - <OpenLayers.Layer.Grid>
 */
OpenLayers.Layer.Acid = OpenLayers.Class(OpenLayers.Layer.Grid, {
     ...
     * {Boolean} Acid Maps Layer should never be a base layer
     */
    isBaseLayer: false,
     ...
     * {AcidProvider} The data-source that will be used by this layer
    ...
    /**
     * Constructor: OpenLayers.Layer.Acid
     * Create a new Acid layer object
     *
     * Example:
     * (code)
     * var acid = new OpenLayers.Layer.Acid("Heatmap",
     ...
     * url - {String} Base url for the Acid Maps server
     *                (e.g. http://acidmaps.xoomcode.com/)
    ...
    configure: function(options) {
      if(options && options.wfs){
        if(typeof(options.attribute) == "undefined"){
          alert("AcidMaps Layer error\n\rWFS attribute not specified");
          return;
        }
        provider = new Acid.Provider.WFS(this, options);
        
      } else if (options && options.points) {
        provider = new Acid.Provider.Array(this, options);
      }
    },
     ...
     *
     * Returns:
     * {<OpenLayers.Layer.Acid>} An exact clone of this layer
     */
    clone: function (obj) {
        
      if (obj == null) {
          obj = new OpenLayers.Layer.Acid(this.name,
            this.url,
            this.params,
            this.getOptions());
      }
    ...
    CLASS_NAME: "OpenLayers.Layer.Acid"
});
 ...
 *
 */
Acid.Provider.WFS = OpenLayers.Class({
 ...
 *
 */
Acid.Provider.Array = OpenLayers.Class({
